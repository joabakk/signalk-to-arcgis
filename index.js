...
// Create a new result object sent by router.
function createArcGis(app) {
  return {
    ...obj, // Spreading all values of obj into a new object.
    features: _.map(app.getPath('vessels'), convertVessel), // Adding features property.
  }
}
